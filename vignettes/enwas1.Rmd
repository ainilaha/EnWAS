...
enwas_all <- function(base_df=base_df, nhanes_db=nhanes_db,
  ...
  return (list(qc_mtx = qc_mtrx,enwas_res = xwas_df))
}
...
qplot(xwas$enwas_res$estimate,xwas_inv$enwas_res$estimate,geom = c("point","smooth")) + theme_minimal() + xlab("EnWAS") + ylab("EnWAS INT")
